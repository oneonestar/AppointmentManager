...
00178     \{
00179         UNKNOWN:
00180         printf(\textcolor{stringliteral}{"Unknown command: %s"}, line);
...
00276         \textcolor{keywordflow}{return} EXIT\_FAILURE;
00277     \}
00278     NumOfUser = argc - 1;
00279     \textcolor{comment}{//Initialize each user in struct user[];}
00280     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i=0; i<NumOfUser; i++)
00281     \{
00282         \textcolor{keywordflow}{if}(GetUserID(argv[i+1]) != -1)
00283         \{
00284             printf(\textcolor{stringliteral}{"Duplicate names of users!\(\backslash\)n"});
00285             exit(EXIT\_FAILURE);
00286         \}
...
00293 
00294     printf(\textcolor{stringliteral}{"~~WELCOME TO AMR~~\(\backslash\)n"});
00295     inputLoop(stdin);
00296     \textcolor{keywordflow}{return} EXIT\_SUCCESS;
00297 \}
\end{DoxyCode}
